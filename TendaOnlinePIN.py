...
distances_table = {
    8: (195528, 195529, 195784, 195785, 196040, 196041, 199310, 251569, 261064, 261065, 261320, 261321, 261576, 261577, 326051, 326600, 326857, 342251, 603760, 744416, 1181172, 3037371, 3299053, 3836421, 4564992, 4569774, 5281265),
...
if __name__ == '__main__':
    ...
    for dist, value in distances.items():
        ...
        pin = value['pin']
        temp_pins = []
        if abs(dist) not in distances_table:
            continue
